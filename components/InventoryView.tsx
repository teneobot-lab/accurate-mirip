        ...
        <div className="flex flex-col h-full bg-mist-50 font-sans">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/10 backdrop-blur-[2px] p-4 animate-in fade-in">
                    <div className="bg-white w-full max-w-xl rounded-xl shadow-2xl border border-mist-300 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95">
                        ...
                        <form onSubmit={handleSaveItem} className="flex-1 overflow-y-auto p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                <div className="space-y-1.5">
                                    ...
                                    <input required type="text" value={formData.code} onChange={e => setFormData({...formData, code: e.target.value.toUpperCase()})} className="w-full px-3 py-2 bg-white border border-mist-300 rounded-lg text-xs font-mono font-bold uppercase outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-50 transition-all" placeholder="CTH: BRG-001" />
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase">Kategori</label>
                                    <input type="text" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})} className="w-full px-3 py-2 bg-white border border-mist-300 rounded-lg text-xs outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-50 transition-all" placeholder="Umum" />
                                </div>
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input required type="text" value={formData.baseUnit} onChange={e => setFormData({...formData, baseUnit: e.target.value.toUpperCase()})} className="w-full px-3 py-2 bg-white border border-mist-300 rounded-lg text-xs font-bold text-center uppercase outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-50 transition-all" placeholder="PCS" />
                                </div>
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase">Min. Stock Alert</label>
                                    <input type="number" value={formData.minStock} onChange={e => setFormData({...formData, minStock: Number(e.target.value)})} className="w-full px-3 py-2 bg-white border border-mist-300 rounded-lg text-xs font-bold outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-50 transition-all" />
                                </div>
                            ...
                            <div className="border-t border-mist-200 pt-5">
                                ...
                                <div className="space-y-3">
                                    {formData.conversions?.map((conv, idx) => (
                                        <div key={idx} className="flex items-center gap-2 bg-mist-50 p-2 rounded-lg border border-mist-200 animate-in slide-in-from-left-2">
